...
<head>
    <title>Industri Kecil dan Menengah : E-Industri</title>
...
<body>
    ...
    <div class="title-data">
        <h2>Industri Kecil dan Menengah</h2>
    </div> 
	...
	<div class="data" style="margin-left: 160px;margin-top: -50px;  width: 20%; padding: 10px; ">
			<h4 style="margin-top: 10px; margin-bottom: 15px;text-align:center">Filter Data Berdasarkan Nama Bidang</h4>
			...
			<br>
				<input type="submit" name="pilih" value="Pilih" style="margin-top: 5px; width: 50px; background-color: #76cfa8; border-radius: 5px; padding: 5px">
			</form>
		</div>

		<div class="data" style="margin-left: 460px; margin-top: -115px; width: 22%; padding: 8px;">
		...
		<div class="tabel-content" style="margin-top: -10px;margin-bottom: 60px;">
			...
			<h2 style="width: 70%;padding: 8px 20px;margin-left: 12%">Data IKM yang anda cari </h2>
        ...
        <div class="tabel-content" style="margin-top: -30px;">
			<table cellpadding="0" cellspacing="0" style="width: 70%;margin-left: 12%;text-align: center">
				<tbody style="text-align: center;font-size: 12px;">
					<tr>
						<th>Kode Industri</th>
