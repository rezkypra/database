...
include 'konek.php';
$query = "SELECT * FROM `ikm` WHERE `nama_bidang` = '20299'" ;
...
<head>
    <title>Bidang Kimia dan Bahan Bangunan : E-Industri</title>
...
<body>
    ...
    <div class="title-data">
        <h2>Data Industri Bidang Kimia dan Bahan Bangunan</h2>
    </div> 
