				...
				<tbody style="font-size: 16px;">
					...
					<tr>
						...
						<td style="text-align: center;display: flex;">
							<div style="width: 50%;"><a href="edit_akun.php?kode_user=<?= $row['kode_user'] ?>"><img src="../image/edit.png" alt=""></a></div>
							<div style="width: 50%;border-left: 2px solid"><a href="hapus_akun.php?kode_user=<?= $row['kode_user'] ?>"><img src="../image/delete.png" alt=""></a></div>
						</td>
					</tr>
