...
<body>
				...
				<tbody style="font-size: 16px;">
					...
					<tr>
						...
						<td style="text-align: center;display: flex;">
							<div style="width: 50%; margin-left: 10px;"><a href="detail_industri.php?kode_industri=<?= $row['kode_industri'] ?>"><img src="../image/detail.png" alt=""></a></div>
						</td>
					</tr>
		...
		<div class="tabel-content" style="margin-top: -30px; margin-bottom: 80px">
