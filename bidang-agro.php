...
include 'konek.php';
$query = "SELECT ikm.*, kecamatan.nama_kecamatan FROM `ikm`, kecamatan WHERE kecamatan.kode_kecamatan = ikm.kode_kecamatan AND `kode_bidang` = '10750'" ;
...
<head>
    <title>Bidang Agro : E-Industri</title>
...
<body>
    ...
    <div class="title-data">
        <h2>Data Industri Bidang Agro</h2>
    </div> 
    ...
    <div class="tabel-content">
        	...
        	<?php $result = mysqli_query($konek, "SELECT ikm.*, bidang_ikm.nama_bidang, kecamatan.nama_kecamatan FROM `ikm`, bidang_ikm, kecamatan WHERE bidang_ikm.kode_bidang = ikm.kode_bidang AND kecamatan.kode_kecamatan = ikm.kode_kecamatan AND bidang_ikm.nama_bidang = 'Agro' AND (kode_industri LIKE '%$keyword%' OR nama_industri LIKE '%$keyword%' OR nama_pemilik LIKE '%$keyword%' OR kontak LIKE '%$keyword%' OR alamat_industri LIKE '%$keyword%' OR nama_kecamatan LIKE '%$keyword%' OR nama_bidang LIKE '%$keyword%')"); ?>
				...
				<table cellpadding="0" cellspacing="0" style="width: 70%;margin-left: 12%;text-align: center">
					...
					<?php 
						if (isset($_GET['nama_kecamatan'])) {
							...
							$sql = mysqli_query($konek, "SELECT ikm.*, bidang_ikm.nama_bidang, kecamatan.nama_kecamatan FROM `ikm`, bidang_ikm, kecamatan WHERE bidang_ikm.kode_bidang = ikm.kode_bidang AND kecamatan.kode_kecamatan = ikm.kode_kecamatan AND bidang_ikm.nama_bidang = 'Agro' AND (nama_kecamatan = '$nama_kecamatan')");
						}
					?>
						<?php error_reporting(0); ?>
