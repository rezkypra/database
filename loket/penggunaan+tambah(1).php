...
<body>
	<div style="width: 99.8%;display: flex;height: 110%;background: #54f785;position:fixed">	
		...
		<div class="content" style="width: 80%; display: block;text-align: left;line-height: 2;padding-bottom:20px">
            <br><br>
			<h1 style="text-align: center;margin-bottom: 25 px">Tambah Penggunan Pelanggan</h1>
      		<form action="penggunaan+proses.php" method="POST">
				<table style="width: 60%;overflow-x: scroll;margin:auto" cellspacing="0">
					...
					<tr>
						...
						<td style="width: 65%;padding: 10px 20px"><input type="text" name="IDPenggunaan" style="border:1px solid;border-radius:5px;font-weight:700;width: 100%;text-decoration: none;padding: 7px 10px;" required="true" autocomplete="off"></td>
					</tr>
					<tr>
						<td style="width: 35%;padding: 10px 20px">Nama Pelanggan</td>
                        <td style="width: 65%;padding: 10px 20px;padding-right: 0">
							<select name="IDPelanggan" id="IDPelanggan" style="border:1px solid;border-radius:5px;font-weight:700;width: 100%;text-decoration: none;padding: 7px 10px;" required="true" autocomplete="off">
								<option value="">Pilih Nama pelanggan</option>

								<?php 

									$query = $konek->query("SELECT * FROM pelanggan");
					...
					<tr>
						...
						<td style="width: 65%;padding: 10px 20px;padding-right: 0">
							<select name="Bulan" id="Bulan" style="border:1px solid;border-radius:5px;font-weight:700;width: 100%;text-decoration: none;padding: 7px 10px;" required="true" autocomplete="off">
					...
					<tr>
						...
						<td style="width: 65%;padding: 10px 20px"><input type="text" name="Tahun" style="border:1px solid;border-radius:5px;font-weight:700;width: 100%;text-decoration: none;padding: 7px 10px;" required="true" autocomplete="off"></td>
					</tr>
					<tr>
						<td style="width: 35%;padding: 10px 20px">Meter Awal</td>
						<td style="width: 65%;padding: 10px 20px"><input type="text" name="Meterawal" style="border:1px solid;border-radius:5px;font-weight:700;width: 100%;text-decoration: none;padding: 7px 10px;" required="true" autocomplete="off"></td>
					</tr>
					<tr>
						<td style="width: 35%;padding: 10px 20px">Meter Akhir</td>
                        <td style="width: 65%;padding: 10px 20px"><input type="text" name="Meterakhir" style="border:1px solid;border-radius:5px;font-weight:700;width: 100%;text-decoration: none;padding: 7px 10px;" required="true" autocomplete="off"></td>
                    </tr>
					<tr>
